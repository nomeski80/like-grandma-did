...
The goals for this site are to provide an effective, easy to use, step by step guide to cooking traditional family handed down recipies. To encourage peopel to go back to their roots and to think about what happy nostalgic memories htey have from their own childhood and quality time they may have spent with their grandparents.The app should be visually pleasing, easy to navigate, intuative to use and an essential tool for the kitchen when cooking for the family. 
...
## User Stories
User Stories have been written out in teh Kanboard and matched with teh milestones, they have been labled and prioratized with 'must have, 'should have' and 'could have'. 
...
<br>
 “pictural icons".
Content - "As site user, I can easily see the time, difficulty and expense of a recipe in icon format so that I 
...
## Technologies Used
Django, HTML, CSS, Java Script, Bootstrap, Heroku to deploy my project and make it visable to users, Cloudinary to store images, Canva to create the logo, Crispy forms to help with consistancy of the forms and GhatGpt to create content for some of the recipies. 
...
I could not get summernote to work to help to customise the forms. Solution, changed to summernote_fields to match my model with ingredients and instructions.
